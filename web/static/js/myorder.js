...
function setPage(begin, pageNow, pagination, pageCount, pageTotal) {
    ...
    $('<a class="page_action page_controller" page="' + prePage + '"><img src="' + basePath + '/static/img/zuo.jpg"/></a>').appendTo(pagination);
    ...
    $('<a class="page_action page_controller" page="' + endPage + '"><img src="' + basePath + '/static/img/you.jpg"/></a>').appendTo(pagination);
