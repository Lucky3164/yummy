...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/pro.js"></script>
    ...
    <div class="cart mt"><!-----------------logo------------------->
        ...
        <div class="site">
            <p class=" wrapper clearfix">
                ...
                <img class="top" src="${pageContext.request.contextPath}/static/img/temp/cartTop01.png">
                <a href="${pageContext.request.contextPath}/pages/shopping.jsp" class="fr">继续购物&gt;</a>
            </p>
        </div><!-----------------table------------------->
        <div class="table wrapper" id="cart_table">
            ...
            <div class="th clearfix">
                ...
                <p class="fr">
                    ...
                    <button type="button" class="btn btn-link" id="count_cart_btn" disabled="disabled">结算</button></p>
            </div>
        </div>
    </div>
        ...
        <div class="proCon clearfix">
            <div class="proImg fr">
                ...
                <div class="smallImg clearfix">
                    <img src="${pageContext.request.contextPath}/static/img/temp/proDet01.jpg" data-src="img/temp/proDet01_big.jpg">
                    <img src="${pageContext.request.contextPath}/static/img/temp/proDet02.jpg" data-src="img/temp/proDet02_big.jpg">
                    <img src="${pageContext.request.contextPath}/static/img/temp/proDet03.jpg" data-src="img/temp/proDet04_big.jpg">
                </div>
            </div>
            <div class="fl">
                <div class="proIntro change">
                    ...
                    <div class="smallImg clearfix">
                        <p class="fl on">
                            <img src="${pageContext.request.contextPath}/static/img/temp/prosmall01.jpg" alt="白瓷花瓶+20支快乐花" data-src="img/temp/proBig01.jpg">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/static/img/temp/prosmall02.jpg" alt="白瓷花瓶+20支兔尾巴草" data-src="img/temp/proBig02.jpg">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/static/img/temp/prosmall03.jpg" alt="20支快乐花" data-src="img/temp/proBig03.jpg">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/static/img/temp/prosmall04.jpg" alt="20支兔尾巴草" data-src="img/temp/proBig04.jpg">
                        </p>
                    </div>
                </div>
