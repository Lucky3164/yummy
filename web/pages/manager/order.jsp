...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/jquery-3.3.1.min.js" type="text/javascript"
...
<div class="order cart mt"><!-----------------site------------------->
    <div class="site"><p class="wrapper clearfix">
        ...
        <img class="top" src="${pageContext.request.contextPath}/static/img/temp/cartTop02.png"></p>
    </div><!-----------------orderCon------------------->
    <div class="orderCon wrapper clearfix">
        <div class="orderL fl"><!--------h3---------------->
            ...
            <div class="way clearfix">
                <img class="on" src="${pageContext.request.contextPath}/static/img/temp/way01.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/way02.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/way03.jpg">
                <img src="${pageContext.request.contextPath}/static/img/temp/way04.jpg">
            </div>
        </div>
        <div class="orderR fr">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>订单内容
                        <a href="${pageContext.request.contextPath}/pages/cart.jsp" class="fr">返回购物车</a>
                    </h3>
                </div>
