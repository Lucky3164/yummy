...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/shopping.css" />
    <script src="${pageContext.request.contextPath}/static/js/shopping.js" ></script>
...
<div id="main_header">
    <!-- 导航条 -->
    <nav>
        <img src="${pageContext.request.contextPath}/static/images/logo2.png" alt="美食食尚" title="美食食尚" id="logo" />
        <ul id="title">
            <li class="pageName">
                <a href="#">首页</a>
            </li>
